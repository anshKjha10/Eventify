  ...
  return (
    <div className="auth-page">
      ...
      <style>{`
        ...
        .auth-logo { font-size: 26px; font-weight: 800; color: var(--clr-primary); letter-spacing: -0.5px; }
        ...
        .auth-field input {
          ...
          background: transparent; font-size: 15px; color: var(--clr-text);
        }
        .eye-btn { background: none; border: none; padding: 0; display: grid; place-items: center; }
        .auth-submit-btn {
          margin-top: 8px; padding: 15px; border: none;
